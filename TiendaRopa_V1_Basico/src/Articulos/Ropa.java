...
public abstract class Ropa extends Articulo {
    ...
    public Ropa(String nombre, float precio, String descripcion, String marca, 
                int talla, String color) {
    ...
    public Ropa(String codigoProducto, String nombre, float precio, 
