...
public class Zapatos extends Accesorio {
    ...
    // Constructor con todos los atributos con cod 
    public Zapatos(String codigoProducto, String nombre, float precio, 
            String descripcion, String marca, String tipo, String material,
            String estilo, boolean esPersonalizado, int tallaZapatos, 
            String tipoSuela) {
        super(codigoProducto,nombre, precio, descripcion, marca, tipo, material,
                estilo, esPersonalizado);
        this.tallaZapatos = tallaZapatos;
        this.tipoSuela = tipoSuela;
    }
    // Constructor con todos los atributos sin cod 
    public Zapatos( String nombre, float precio, 
            String descripcion, String marca, String tipo, String material,
            String estilo, boolean esPersonalizado, int tallaZapatos, 
            String tipoSuela) {
    ...
    public Zapatos(String codigoProducto, String nombre, float precio, 
            String tipo, int tallaZapatos) {
        super(codigoProducto, nombre, precio, "", "", tipo, "", "", false);
        this.tallaZapatos = tallaZapatos;
    ...
    public Zapatos(String codigoProducto, String nombre, float precio, 
            int tallaZapatos) {
        super(codigoProducto, nombre, precio, "", "", "", "", "", false);
        this.tallaZapatos = tallaZapatos;
    }
     // Constructor con información mínima
    public Zapatos(String nombre, float precio, 
