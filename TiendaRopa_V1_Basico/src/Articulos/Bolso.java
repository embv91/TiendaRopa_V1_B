...
public class Bolso extends Accesorio {
    ...
    public Bolso(String codigoProducto, String nombre, float precio, 
            String descripcion, String marca, String tipo, String material,
            String estilo, boolean esPersonalizado, int capacidad, 
            String tipoCierre) {
        super(codigoProducto, nombre, precio, descripcion, marca, tipo,
                material, estilo, esPersonalizado);
    ...
    public Bolso(String nombre, float precio, String descripcion, String marca,
            ...
            int capacidad, String tipoCierre) {
        super(nombre, precio, descripcion, marca, tipo,
                material, estilo, esPersonalizado);
        this.capacidad = capacidad;
        this.tipoCierre = tipoCierre;
    }
