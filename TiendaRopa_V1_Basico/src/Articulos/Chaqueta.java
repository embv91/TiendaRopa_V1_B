...
public class Chaqueta extends Ropa {
    ...
    public Chaqueta(String codigoProducto, String nombre, float precio, 
            String descripcion, String marca, int talla, String color, 
            String tipoCierre, boolean impermeable, String materialExterior) {
        super(codigoProducto, nombre, precio, descripcion, marca, talla, color);
        this.tipoCierre = tipoCierre;
        this.impermeable = impermeable;
        this.materialExterior = materialExterior;
    }
    // Constructor con todos los atributos sin cod de artículo
    public Chaqueta(String nombre, float precio, 
            String descripcion, String marca, int talla, String color, 
            String tipoCierre, boolean impermeable, String materialExterior) {
    ...
    // Constructor sin descripción ni marca con cod art
    public Chaqueta(String codigoProducto, String nombre, float precio, 
     ...
     // Constructor sin descripción ni marca sin cod art
    public Chaqueta(String nombre, float precio, int talla, String color, 
            String tipoCierre, boolean impermeable, String materialExterior) {
